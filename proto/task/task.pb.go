...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\x0fListTasksByUser\x12\x1c.task.ListTasksByUserRequest\x1a\x1d.task.ListTasksByUserResponseB/Z-github.com/your-org/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_goTypes = []any{
	...
	(*GetTaskResponse)(nil),         // 2: task.GetTaskResponse
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	1,  // 6: task.TaskService.GetTask:input_type -> task.GetTaskRequest
	...
	11, // 10: task.TaskService.ListTasksByUser:input_type -> task.ListTasksByUserRequest
	4,  // 11: task.TaskService.CreateTask:output_type -> task.CreateTaskResponse
	2,  // 12: task.TaskService.GetTask:output_type -> task.GetTaskResponse
	...
	10, // 15: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
	12, // 16: task.TaskService.ListTasksByUser:output_type -> task.ListTasksByUserResponse
