...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	4,  // 9: task.TaskService.CreateTask:output_type -> task.CreateTaskResponse
	2,  // 10: task.TaskService.GetTask:output_type -> task.GetTaskResponse
